...
const Upload = ({setOpen}) => {
    ...
    const uploadFile = async (file,urlType) => {
        try {
            ...
            console.log(2)
            const fileName = currentUser._id + "/" + file.name + Math.random().toString(16).slice(2).toString();
    ...
    const handleUpload = async (e)=>{
        ...
        const res = await axios.post(`${api}/videos`, {...inputs, tags,access_token})
        setOpen(false)
  ...
  return (
    <Container>
        <Wrapper>
            ...
            <Input type='text' placeholder="Seperate tags with comma" onChange={handleTags}/>
            <Label>Image:</Label>
